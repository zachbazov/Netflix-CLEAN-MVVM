...
//
//        guard let state = SegmentControlView.State(rawValue: item.tag) else { return }
//
...
//
//    func viewDidConfigure(for state: SegmentControlView.State)
//}
//
...
//    func viewDidConfigure(for state: SegmentControlView.State) {
//        print(111)
//        guard let tag = SegmentControlView.State(rawValue: tag) else { return }
//        // Release changes for `categories` item depending the navigation state.
//        if case .main = state, case .categories = tag {
